...
// Creating the object as an automatic variable causes compilation error on Linux but builds fine on Windows
...
// Creating the object as a heap variable works fine on Linux and on Windows
  NDPluginStats *pStats = new NDPluginStats("STATS1", 20, 0, "SIM1", 0, 0, 0, 0, 0, 0);
}
