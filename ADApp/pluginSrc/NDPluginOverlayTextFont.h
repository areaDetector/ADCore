...
} NDPluginOverlayTextFontBitmapType;


extern NDPluginOverlayTextFontBitmapType NDPluginOverlayTextFontBitmaps[];
extern const int NDPluginOverlayTextFontBitmapTypeN;
