...
asynNDArrayDriver::asynNDArrayDriver(asynNDArrayDriverParamSet* paramSet,
                                     const char *portName, int maxAddr, int maxBuffers,
                                     size_t maxMemory, int interfaceMask, int interruptMask,
                                     int asynFlags, int autoConnect, int priority, int stackSize)
    : asynPortDriver(paramSet,
                     portName, maxAddr,
      ...
      pNDArrayPool(NULL), paramSet(paramSet), queuedArrayCountMutex_(NULL), queuedArrayCount_(0),
